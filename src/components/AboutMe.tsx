const AboutMe = () => {
    return (
        <>
            ...
            <p>I'm currently immersed in coding school with Epicodus, honing skills and unlocking new ones. Currently exploring Javascript, React, and C#. Really looking forward to implementing what I've learned at Epicodus while learning new skills on the job.</p>
        </>
    )
}
